...
OWNER_ID = int(getenv("OWNER_ID", 5023305007))
...
CHANNEL_NAME = getenv("CHANNEL_NAME", "𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐇𝐃")
CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/S_S_U_M")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/S_S_U_M")
